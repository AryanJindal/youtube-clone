      ...
      <div className="col-span-8">
        <div className="flex flex-row">
          <input
            ...
            placeholder="Search"
          />
          <button className="border-black  bg-gray-200 border-l-0 rounded-r-full border-2 font-bold py-2 px-4 inline-block w-full md:w-auto sm:w-auto py-2 md:mt-0 sm:mt-0 ">
            Search
          </button>
        </div>
      </div>
